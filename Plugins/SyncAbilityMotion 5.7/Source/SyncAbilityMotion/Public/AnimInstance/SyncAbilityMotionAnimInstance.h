...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Anim|Movement", meta=(EditCondition="bDriveControllerYawFromAbilityState"))
	bool bOverrideControllerYawRotationRate = true;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Anim|Movement", meta=(EditCondition="bOverrideControllerYawRotationRate", ClampMin="0.0"))
	float ControllerYawRotationRate = 1440.f;
...
protected:
	...
	void CacheControllerYawSettings();
	void RestoreControllerYawSettings();
	...
	UPROPERTY()
	bool bHasCachedControllerYawSettings = false;
